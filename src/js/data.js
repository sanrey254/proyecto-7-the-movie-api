...
window.drawData = (dataArray) => {
  ...
  dataArray.forEach(data => {
    ...
    result += `<div class="col-6 col-sm-4 col-md-3 col-lg-3 my-3">
					    ...
					    <img class="img-fluid height-img" src="${poster}"><div class="card-body">
...
window.drawDataDetails = (dataArray) => {
  ...
  const card = `<div class="container pl-4"><div class="card"><div class="row ">
        <div class="col-md-6 px-0"><img src="${poster}" class="img-fluid img-card"></div>
          <div class="col-md-6 pl-0"><div class="card-block p-3 text">
              ...
              <div class="text-left">
                <span class="card-text-details pb-1 d-block"><strong>Clasificación: </strong>${dataArray.Rated}</span><span class="card-text-details py-1 d-block"><strong>Año: </strong>${dataArray.Year}</span><span class="card-text-details py-1 d-block"><strong>País: </strong>${dataArray.Country}</span><span class="card-text-details py-1 d-block"><strong>Categoríass: </strong>${dataArray.Genre}</span><span class="card-text-details pt-1 d-block small-text"><strong>Reseña: </strong>${dataArray.Plot}</span>
  ...
  topMovies.forEach((element, i) => {
    fetch(`https://www.omdbapi.com/?apikey=add73b1a&i=${element}`)
      ...
      .then(data => {
        ...
        result += `<div class="col-6 col-sm-4 col-md-3 col-lg-3 my-3"><div class="card hoverable">
					    <img class="img-fluid height-img" src="${poster}">
					    <div class="card-body"><h4 class="card-title">${data.Title}</h4>
                <div class="row">
                  <div class="col-md-6"><p class="card-text">${type}</p></div>
                    <div class="col-md-6"><span class="badge badge-dark"><i class="fas fa-info-circle"></i><button class="no-btn text-white" onclick="getDetails('${data.imdbID}')">Detalles</button></span></div>
                </div></div></div></div>`;
